  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'bg-popover text-popover-foreground data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 relative z-50 max-h-60 min-w-[8rem] overflow-hidden rounded-md border shadow-md',
          position === 'popper' &&
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            'p-1',
            position === 'popper' &&
              'custom-scrollbar max-h-56 w-full min-w-[var(--radix-select-trigger-width)] overflow-y-auto',
          )}
        >
          {children}
        </SelectPrimitive.Viewport>
